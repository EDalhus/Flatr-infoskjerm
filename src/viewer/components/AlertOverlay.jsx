...
export default function AlertOverlay({ alerts }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex animate-alert-in flex-col items-center justify-center bg-danger p-16 text-center">
      <div className="text-2xl font-black uppercase tracking-[0.4em] text-white/85">
        Viktig beskjed
      </div>
      <div className="mt-8 text-6xl font-extrabold leading-tight text-white portrait:text-4xl">
        {active.message}
      </div>
    </div>
  );
